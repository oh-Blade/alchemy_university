...
describe('Game3', function () {
  ...
  it('should be a winner', async function () {
    const { game, signer0, signer1, signer2 } = await loadFixture(deployContractAndSetVariables);
    ...
    await game.win(signer0.getAddress(), signer1.getAddress(), signer2.getAddress());
